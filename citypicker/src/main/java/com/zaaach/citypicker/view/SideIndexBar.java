...
public class SideIndexBar extends View{
    private static final String[] DEFAULT_INDEX_ITEMS = {"历史", "热门", "A", "B", "C", "D", "E", "F", "G", "H", "J", "K", "L", "M", "N", "P", "Q", "R", "S", "T", "W", "X", "Y", "Z"};
...
//                        mOnIndexChangedListener.onIndexChanged(mIndexItems.get(touchedIndex), touchedIndex);
            ...
            case MotionEvent.ACTION_CANCEL:
                mOnIndexChangedListener.onIndexChanged(mIndexItems.get(mCurrentIndex), mCurrentIndex);
                mCurrentIndex = -1;
                if (mOverlayTextView != null){
